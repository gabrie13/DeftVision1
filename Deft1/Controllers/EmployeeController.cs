...
using Deft1.Models;
using Deft1.Services;

namespace Deft1.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,PositionId,Locationid,FirstName,LastName,Phone,Email,HireDate")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,PositionId,Locationid,FirstName,LastName,Phone,Email,HireDate")] Employee employee)
        {
            if (ModelState.IsValid)
            {
